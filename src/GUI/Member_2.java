...
public class Member_2 extends JFrame {
	...
	public Member_2() {
		...
		M2_Label = new JLabel("MEMBER 2");
		M2_Label.setFont(new Font("Tahoma", Font.PLAIN, 15));
		M2_Label.setBounds(256, 4, 85, 25);
		contentPane.add(M2_Label);
	}
}